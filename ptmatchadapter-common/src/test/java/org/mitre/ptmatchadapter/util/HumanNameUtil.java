...
public abstract class HumanNameUtil {
  ...
  public static HumanName newHumanName(String fullName, String[] family, String[] given) {
    return newHumanName(fullName, family, given, null);
  }

  public static HumanName newHumanName(String fullName, String[] family, String[] given, String[] suffix) {
    return newHumanName(fullName, family, given, suffix, null);
  }
  
  public static HumanName newHumanName(String fullName, String[] family, String[] given, String[] suffix, NameUse use) {
